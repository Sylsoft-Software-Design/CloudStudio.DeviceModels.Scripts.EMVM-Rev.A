...
# Configuration Script – EMVM - Rev. A

This **Configuration** script is designed for the **EMVM** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – EMVM Rev. A

Este script de **Configuration** está diseñado para el modelo **EMVM** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
